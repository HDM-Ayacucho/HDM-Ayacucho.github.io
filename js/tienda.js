...
function pagarClicked() {
    // Recopilamos información del carrito
    var carritoItems = document.getElementsByClassName('carrito-item');
    var mensaje = "Hola ,quisiera adquirir estos productos\n";
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        mensaje += `${cantidad} x ${titulo} - ${precio}\n`;
    }
    ...
    var numeroWhatsApp = "913882945"; // Reemplaza con el número de WhatsApp deseado
    
    // Codificamos el mensaje para URL
    var mensajeCodificado = encodeURIComponent(mensaje);
    
    // Creamos la URL de WhatsApp
    var urlWhatsApp = `https://api.whatsapp.com/send?phone=${numeroWhatsApp}&text=${mensajeCodificado}`;
...
function actualizarTotalCarrito() {
    ...
    var carritoContenedor = document.getElementsBy}